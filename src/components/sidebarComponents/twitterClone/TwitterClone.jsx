      ...
      <div className="msgUsers">
        ...
        <div className="msgUsersMain">
          <p className="mainMsg p-3">
            ...
            Recusandae voluptatem incidunt doloremque. Consectetur, numquam modi
            vitae nulla rem beatae ullam qui nostrum quo? Odio dolore autem
            minus dolorem porro sit!
          </p>
        </div>
